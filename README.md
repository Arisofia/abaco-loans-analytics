...
An automation in `.github/workflows/pr-auto-assign.yml` keeps those assignments in sync on open/update; verify the PR template captures tests, alerts, and data lineage alongside the reviewers.
