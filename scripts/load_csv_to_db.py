...
def load_data():
    ...
    with psycopg.connect(DB_DSN) as conn:
        with conn.cursor() as cur:
            ...
            df_cust_mapped['birth_date'] = pd.to_datetime(df_cust_mapped['birth_date'].astype(str) + '-01-01', errors='coerce').dt.date
            ...
            # Handle dates
            df_loan_mapped['disbursement_date'] = pd.to_datetime(df_loan_mapped['disbursement_date'], errors='coerce').dt.date
            ...
            # Handle dates
            df_pay_mapped['true_payment_date'] = pd.to_datetime(df_pay_mapped['true_payment_date'], errors='coerce').dt.date
