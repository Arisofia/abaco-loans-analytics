...
- 📄 **Audit Integration**: `python/pipeline/AUDIT_INTEGRATION_GUIDE.md`
- 🔧 **Supabase Writer**: `python/abaco_pipeline/output/supabase_writer.py`
- ⚙️ **Settings**: `python/abaco_pipeline/settings.py`
