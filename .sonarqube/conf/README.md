...
- **Directory Owners:** @Arisofia, @data-engineering
- For questions, incidents, or exceptions, open an issue with the `qa` or `security` labels.

This policy enforces security, auditability, and operational clarity for all SonarQube configuration in abaco-loans-analytics.
