...
- **Engineering (PR Assignee)**: Implements changes, ships tests, and updates observability; assigns PRs to `@codex` and requests reviews from `@sonarqube`, `@coderabbit`, and `@sourcery` to enforce quality gates.
